...
import seederData from "./articles.seeder.json";
...
const ArticlesSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ArticlesSeederDialogComponent);
